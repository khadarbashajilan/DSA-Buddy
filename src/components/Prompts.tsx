...
const Prompts = () => {
  ...
  return (
    <div className="flex md:mb-10 flex-col gap-5 items-center justify-end h-full">
      <div className="flex *:cursor-pointer flex-wrap justify-center gap-2 text-center *:bg-gray-200 *:hover:bg-gray-300 *:hover:transition-colors:duration-300 *:text-gray-800 *:font-semibold *:py-5 *:px-6 *:rounded-3xl md:text-[18px] text-[15px]  ">
