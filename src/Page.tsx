    ...
    <main className="overflow-hidden p-2 h-screen">
      <div className="h-[88vh] md:h-[95vh] gap-2 w-full flex flex-col  rounded-2xl border-5 p-4 overflow-hidden"> 
        ...
        <div className="flex flex-col gap-3 justify-end h-full"> 
          <div className="flex *:cursor-pointer flex-wrap justify-center gap-2 text-center *:text-center *:bg-gray-100 *:hover:bg-gray-200 *:text-gray-800 *:font-semibold *:py-5 *:px-6 *:rounded-3xl *:text-sm *:md:text-base "> {/* Flexbox for horizontal prompts, wrap for overflow */}
          ...
          <form className="rounded-4xl flex items-center gap-2 w-full py-2 px-4 border-2"
